...
//   console.log('RESPONSE', response);
//   console.log('RESPONSE BODY', responseBody); // Log the actual error message from SendGrid
...
// export async function POST({ request }) {
//   const { clientId, shipmentNumber, carrier, trackingNumber, poNumber, recipientName,
//   } = await request.json();
...
//     from: { email: 'storageandfulfillment@hometown-industries.com', name: 'Inventory Update' },
//     content: [{
//       type: 'text/html', value: `<p>Tracking has been updated for Shipment Number: ${shipmentNumber}</p> 
//       <ul>
//       <li><strong>Carrier:</strong> ${carrier}</li>
//       <li><strong>Tracking Number:</strong> ${trackingNumber}</li>
//       </ul>
