...
// export const totalOutboundShipmentCount = writable(0)
// /** @type {import('svelte/store').Writable<number>} */
...
//   console.log('loadOutboundShipments called with:', {
...
//     let countQuery = supabase.from('Outbound_Shipments').select('*', { count: 'exact', head: true })
...
//     totalOutboundShipmentCount.set(count || 0)
...
//     console.log('Total count after query:', get(totalOutboundShipmentCount))
